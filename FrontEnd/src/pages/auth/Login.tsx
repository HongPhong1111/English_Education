                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative flex items-center">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-12 pr-12 py-4 rounded-xl bg-slate-100 dark:bg-slate-800 border-2 border-transparent focus:border-primary-500 focus:ring-0 text-slate-900 dark:text-white placeholder-slate-500 font-medium text-lg transition-all"
                                                placeholder="••••••••"
                                                required
                                            />
                                            <button
